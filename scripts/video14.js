...
var videoMarkup = `
  <div id="video-box">
   <video id="video-content" autoplay loop muted playsinline>
    <source src="https://cdn.jsdelivr.net/gh/notflat3/authentic-duplicate-website/assets/videos/aud-landing-page.mp4" type="video/mp4">
...
function homeContent() {
  ...
  const cssLink =
    "https://cdn.jsdelivr.net/gh/notflat3/authentic-duplicate-website/styles/styles8.css";
...
function removeAUD() {
  ...
  $('link[rel=stylesheet][href~="https://cdn.jsdelivr.net/gh/notflat3/authentic-duplicate-website/styles/styles8.css"]').remove();
  });
}
